  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="flex items-center justify-between px-3 py-2 border-b border-border shrink-0">
        <span className="text-[10px] font-semibold uppercase tracking-[0.1em] text-muted-foreground/70">Exchange Flows (ETH)</span>
            ...
            <div key={ex.name} className="px-3 py-2.5 hover:bg-secondary/30 transition-colors duration-100">
              ...
              <div className="grid grid-cols-3 gap-2 text-[10px] animate-fade-in">
                ...
                <div className="text-right">
                  ...
                  <div className={`num font-medium ${ex.netFlow > 0 ? "text-negative" : "text-positive"}`}>
