...
export function CommandBar() {
  ...
  const commands: CommandItem[] = [
    ...
    { id: "crypto-calendar", label: "Raises & Rounds", description: "Recent crypto fundraising rounds and investments", keywords: ["calendar", "raise", "funding", "round", "seed", "series", "investment", "vc", "fundraise"], icon: CalendarDays, category: "widget", action: () => handleWidgetAction("crypto-calendar") },
