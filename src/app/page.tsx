...
export default function Home() {
  ...
  return (
    <TerminalShell>
      ...
      {/* CTA to enter the full terminal */}
      <div className="flex justify-center py-4">
        <Link
          href="/terminal"
          className="inline-flex items-center gap-2 rounded-md border border-primary/30 bg-primary/10 px-6 py-2.5 text-sm font-bold text-primary transition-colors hover:bg-primary/20"
        >
          Launch Full Terminal &rarr;
        </Link>
      </div>
