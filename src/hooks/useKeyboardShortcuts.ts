...
// ─── Letter/number keys (not in bar, shown in help modal) ───
...
export const SHORTCUT_DESCRIPTIONS: { key: string; description: string }[] = [
  ...
  { key: "Q", description: "Top Movers" },
  { key: "R", description: "Funding Rates" },
  { key: "S", description: "Staking Calculator" },
  { key: "T", description: "Token Screener" },
  { key: "U", description: "Coin Detail" },
  { key: "V", description: "Market Overview" },
  { key: "W", description: "Whale Alerts" },
  { key: "X", description: "Notes" },
  { key: "Y", description: "Trending" },
  { key: "Z", description: "BTC Dominance" },
  // Number keys
  { key: "1", description: "Wallet Tracker" },
  { key: "2", description: "Private Messages" },
  // Special
